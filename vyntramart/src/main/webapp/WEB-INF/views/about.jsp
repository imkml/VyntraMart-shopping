...
<body>
	<div class="container">
		...
		<div class="row">
			<h5>ONLINE SHOPPING MADE EASY AT VYNTRAMART</h5>
			<hr />
			<p>If you would like to experience the best of online shopping
				for men, women and kids in India, you are at the right place.
				VyntraMart is the ultimate destination for fashion and lifestyle,
				...
				VyntraMart from the comfort of your home and get your favourites
				delivered right to your doorstep.</p>

			<h5>BEST ONLINE SHOPPING SITE IN INDIA FOR FASHION</h5>
			<hr />
			<p>Be it clothing, footwear or accessories, VyntraMart offers you
				the ideal combination of fashion and functionality for men, women
				and kids. You will realise that the sky is the limit when it comes
				to the types of outfits that you can purchase for different
				occasions.</p>

			<p>
				<b>Smart men clothing</b> - At VyntraMart you will find myriad
				options in smart formal shirts and trousers, cool T-shirts and
				jeans, or kurta and pyjama combinations for men. Wear your attitude
				with printed T-shirts. Create the back-to-campus vibe with varsity
			...
			<p>
				<b>Trendy women clothing</b> - Online shopping for women at
				VyntraMart is a mood-elevating experience. Look hip and stay
			...
			<p>
				<b>Fashionable footwear</b> - While clothes maketh the man, the type
				...
				sneakers and loafers. Make a power statement at work dressed in
				brogues and oxfords. Practice for your marathon with running shoes
				for men and women. Choose shoes for individual games such as tennis,
				football, basketball, and the like. Or step into the casual style
				and comfort offered by sandals, sliders, and flip-flops. Explore our
			...
			<hr />
			<p>VyntraMart is one of the unique online shopping sites in India
				where fashion is accessible to all. Check out our new arrivals to
				view the latest designer clothing, footwear and accessories in the
				...
				with our seasonal discounts on footwear, trousers, shirts, backpacks
				and more. The end-of-season sale is the ultimate experience when
				fashion gets unbelievably affordable</p>
		</div>
	</div>
</body>
</html>